...
void fill_compressed_weight_representation(int *left_sets,int *right_sets,int *bipart_weights,int n_biparts,int n_species,int *weights,int *two2three,int n_threads);
